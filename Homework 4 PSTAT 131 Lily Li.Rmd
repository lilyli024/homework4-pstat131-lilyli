...
## Q5. Fit each modelto the folded data
...
collect_metrics(tune_qda) # high performance metrics w/ low standard error
```
...
```
## Q8. Use predict(), bind_cols(), and accuracy() to assess your model’s performance on the testing data
```{r}
